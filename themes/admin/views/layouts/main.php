...
<html lang="en">
    <head>
        ...
        $cs->registerCssFile($themeUrl . '/css/bootstrap-switch.css');
        $cs->registerCssFile($themeUrl . '/js/gritter/css/jquery.gritter.css');
        ?>
    ...
    <body>
        <section id="container">
            ...
            $cs->registerScriptFile($themeUrl . '/js/toggle-init.js', $cs_pos_end);
            $cs->registerScriptFile($themeUrl . '/js/gritter/js/jquery.gritter.js', $cs_pos_end);
