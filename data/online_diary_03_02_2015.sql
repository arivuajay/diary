...
insert  into `journal_banner_layout`(`banner_layout_id`,`banner_layout_name`,`banner_layout_page`,`banner_layout_position`,`banner_layout_dimensions`,`created`,`modified`) values (2,'User Inner Top Bar','user_inner','top','',NULL,NULL);
