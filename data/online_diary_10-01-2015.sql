...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 10, 2015 at 06:51 AM
...
CREATE TABLE IF NOT EXISTS `journal_page` (
  ...
  `page_meta_key` varchar(250) DEFAULT NULL,
  `page_meta_description` text,
  `page_status` enum('0','1') DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `modified` datetime DEFAULT NULL,
  PRIMARY KEY (`page_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
(8, 'stanley', 'ptrckstnly@gmail.com', '3627909a29c31381a071ec27f7c9ca97726182aed29a7ddd2e54353322cfb30abb9e3a6df2ac2c20fe23436311d678564d0c8d305930575f60e2d3d048184d79', '1', 'nwBiCBv8n', NULL, NULL, NULL, NULL);
