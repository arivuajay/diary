...
insert  into `journal_banner`(`banner_id`,`banner_image`,`banner_title`,`banner_url`,`banner_layout_id`,`banner_path`,`banner_status`,`created`,`modified`) values (1,'1424161748_468x60.gif','banner1','https://www.google.co.in/',1,'user_inner/top/468x60/','1','2015-02-07 11:56:10','2015-02-07 11:56:10');
...
insert  into `journal_banner_layout`(`banner_layout_id`,`banner_layout_name`,`banner_layout_page`,`banner_layout_position`,`banner_layout_dimensions`,`created`,`modified`) values (1,'user page top','user_inner','top','468*60','2015-02-07 11:54:16','2015-02-07 11:54:16');
...
insert  into `journal_category`(`category_id`,`user_id`,`category_name`,`created`,`modified`) values (1,0,'cat1_edited','2015-01-30 00:00:00','2015-01-30 00:00:00'),(2,0,'cat2',NULL,NULL),(3,0,'cat3',NULL,NULL),(4,0,'new category',NULL,NULL),(5,0,'test cat',NULL,NULL),(6,0,'new cat2',NULL,NULL),(7,11,'New 2','2015-01-30 00:00:00','2015-02-17 12:05:35'),(8,11,'New2','2015-02-17 11:48:50','2015-02-17 11:48:50');
