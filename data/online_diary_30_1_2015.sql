...
insert  into `journal_mood_type`(`mood_id`,`mood_type`,`mood_image`,`created`,`modified`) values (1,'smile','',NULL,NULL),(2,'sad','',NULL,NULL),(3,'Excited','',NULL,NULL);
