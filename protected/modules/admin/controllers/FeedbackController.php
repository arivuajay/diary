    ...
    public function accessRules() {
        return array(
            array('allow', // allow all users to perform 'index' and 'view' actions
                'actions' => array('index', 'view', 'deletemultiple'),
                'users' => array('*'),
            ),
...
//        ));
    ...
    protected function performAjaxValidation($model) {
        ...
        foreach ($_POST['id'] as $id) {
            ...
            if ($contact->delete()) {
                $return['sts'] = 'success';
                $return['text'] = 'Selected Contacts deleted successfully';
            } else {
                $return['sts'] = 'fail';
                $return['text'] = 'Failed to delete this contact: ' . $contact->contact_name;
