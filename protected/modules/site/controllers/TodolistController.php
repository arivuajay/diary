    ...
    public function accessRules() {
        return array(
            ...
            array('allow', // allow authenticated user to perform 'create' and 'update' actions
                'actions' => array('create', 'update', 'delete', 'changeremindme'),
                'users' => array('@'),
            ),
...
//				$this->redirect(array('view','id'=>$model->id));
    ...
    public function actionDelete($id) {
        ...
        Yii::app()->user->setFlash('success', "Reminder deleted successfully!!!");
    ...
    public function actionChangeremindme() {
        $model = $this->loadModel($_POST['todoID']);
        $model->remind_me = 1 - $model->remind_me;
        if ($model->save())
