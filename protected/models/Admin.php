...
//			array('admin_login_ip', 'numerical', 'integerOnly'=>true),
	...
	{
		return array(
			'admin_id' => Yii::t('admin','ADMIN9'),
			'admin_name' => Yii::t('admin','ADMIN10'),
                        'admin_username' => Yii::t('admin','ADMIN3'),
			'admin_password' => Yii::t('admin','ADMIN11'),
			'admin_status' => Yii::t('admin','ADMIN12'),
			'admin_email' => Yii::t('admin','ADMIN13'),
                        'current_password' => Yii::t('admin','ADMIN23'),
                        're_password' => Yii::t('admin','ADMIN24'),
