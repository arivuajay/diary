...
class UsersDetails extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'user_sec_email' => 'Secondary Email ID',
			'user_landline' => 'Landline Number',
			'user_phone' => 'Phone Number',
			'user_martial_status' => 'Marital Status',
			'user_address' => 'Address',
			'user_parent' => 'Parents',
			'user_spouse' => 'Spouse',
			'user_detail_kids' => 'Details Of Kids',
			'user_kid1' => 'Kid 1',
			'user_kid2' => 'Kid 2',
			'user_education' => 'Education',
			'user_area_of_int' => 'Areas of Interest',
			'user_sports_activity' => 'Sports Activities',
			'user_adventure_activity' => 'Adventure Activities',
			'user_fav_color' => 'Favorite Color',
			'user_fav_place' => 'Favorite Place ',
			...
			'user_fav_animal' => 'Your Favourite Animal',
			'user_fav_fruit' => 'Your Favourite Fruit',
			'user_anniversary' => 'Date of Anniversary',
			'user_anniversary_rem' => 'User Anniversary Rem',
			'user_spouse_name' => 'User Spouse Name',
			'user_spouse_dob' => 'Spouse Date of Birth',
			'user_spouse_dob_rem' => 'User Spouse Dob Rem',
			'user_father_name' => 'Father Name',
			'user_mother_name' => 'Mother Name',
			'user_father_bod' => 'Father Date of Birth',
			'user_father_bod_rem' => 'User Father Bod Rem',
			'user_mother_dob' => 'Mother Date of Birth',
			'user_mother_dob_rem' => 'User Mother Dob Rem',
			'user_parent_anniversary' => 'Parents Anniversary Dates',
			'user_parent_anniversary_rem' => 'User Parent Anniversary Rem',
			'user_kid_dob' => 'Kids Date of Birth ',
			'user_kid_dob_rem' => 'User Kid Dob Rem',
			'user_kid_spouse_detail' => 'Kids Spouse Details',
			'user_kid_anniversary' => 'Kids Anniversary Dates',
			'user_kid_detail' => 'Kids Details',
                        'user_parents_detail' => 'Parents',
                        'user_spouse_detail' => 'Spouse',
