...
<link href='http://fonts.googleapis.com/css?family=Raleway:400,100,200,300,500,600,700,800,900' rel='stylesheet' type='text/css'>
 ...
 <?php
        ...
        $cs->registerCssFile($baseUrl.'/css/home/assets/css/bootstrap.css');
        $cs->registerCssFile($baseUrl.'/css/home/assets/css/bootstrap-datetimepicker.min.css');
        $cs->registerCssFile($baseUrl.'/css/home/assets/css/font-awesome.css');
        $cs->registerCssFile($baseUrl.'/css/home/assets/css/animate.min.css');
        $cs->registerCssFile($baseUrl.'/css/home/assets/css/style.css');
        $cs->registerCssFile($baseUrl.'/css/home/assets/css/menu.css');
        $cs->registerCssFile($baseUrl.'/css/home/assets/css/slicknav.css');
        $cs->registerCssFile($baseUrl.'/css/home/assets/css/component.css');
        $cs->registerCssFile($baseUrl.'/css/home/assets/css/cycleslider.css');
        $cs->registerCssFile($baseUrl.'/css/home/assets/css/supersized.css');
        $cs->registerCssFile($baseUrl.'/css/home/assets/css/supersized.shutter.css');
        $cs->registerCssFile($baseUrl.'/css/home/assets/css/portfolio_new.css');
        $cs->registerCssFile($baseUrl.'/css/home/assets/css/prettyPhoto.css');
        $cs->registerCssFile($baseUrl.'/css/home/assets/css/colors/color1.css');
        $cs->registerCssFile($baseUrl.'/css/home/assets/css/supersized.css');
        $cs->registerCssFile($baseUrl.'/css/home/assets/css/supersized.css');
        $cs->registerCssFile($baseUrl.'/css/home/assets/css/supersized.css');
        $cs->registerCssFile($baseUrl.'/css/home/assets/css/supersized.css');
        ...
        $cs->registerScriptFile($baseUrl.'/css/home/assets/js/jquery-1.11.1.min.js');
        $cs->registerScriptFile($baseUrl.'/css/home/assets/js/jquery-migrate-1.2.1.js');
        $cs->registerScriptFile($baseUrl.'/css/home/assets/js/jquery-ui.min.js');
        $cs->registerScriptFile($baseUrl.'/css/home/assets/js/modernizr.custom.js');
        $cs->registerScriptFile($baseUrl.'/css/home/assets/js/jquery-1.11.1.min.js');
        $cs->registerScriptFile($baseUrl.'/css/home/assets/js/jquery-1.11.1.min.js');
        ?>
...
<link rel="shortcut icon" href="<?php echo $baseUrl;?>/css/home/assets/assets/images/favicon.ico" /> 
<link rel="apple-touch-icon" href="<?php echo $baseUrl;?>/css/home/assets/assets/images/apple_touch_icon.png" />
<link rel="apple-touch-icon" sizes="72x72" href="<?php echo $baseUrl;?>/css/home/assets/assets/images/apple_touch_icon_72x72.png" />
<link rel="apple-touch-icon" sizes="114x114" href="<?php echo $baseUrl;?>/css/home/assets/assets/images/apple_touch_icon_114x114.png" />
...
<div id="home" class="item">
				<img src="<?php echo $baseUrl;?>/css/home/assets/img/2.jpg" alt="The Spice Lounge" class="fullBg">
				<div class="clearfix">
			<div class="header_details">
				<div class="container">
					<div class="header_icons accura-header-block accura-hidden-2xs">
						<a href="#"><img src="<?php echo $baseUrl;?>/css/home/assets/img/logo-png.png" border="0"></a></div>
			  <div class="call">
...
<!--  // Home Page Menu section -->
			...
			<div id="boxgallery" class="boxgallery" data-effect="effect-2">
				<div class="panel"><img src="<?php echo $baseUrl;?>/css/home/assets/img/2.jpg" alt="image 2"/></div>
				<div class="panel"><img src="<?php echo $baseUrl;?>/css/home/assets/img/3.jpg" alt="image 3"/></div>
				<div class="panel"><img src="<?php echo $baseUrl;?>/css/home/assets/img/4.jpg" alt="image 4"/></div>
				<div class="panel"><img src="<?php echo $baseUrl;?>/css/home/assets/img/5.jpg" alt="image 5"/></div>
			</div>
		</div>
	</div>
...
<div id="about" class="item">
				<img src="<?php echo $baseUrl;?>/css/home/assets/img/12.jpg" alt="The Spice Lounge" class="fullBg">
				<div class="content">
...
=============================--> 
		<div id="menu1" class="item">
			<img src="<?php echo $baseUrl;?>/css/home/assets/img/5.jpg" alt="The Spice Lounge" class="fullBg">
			<div class="content">
				<div class="content_overlay"></div>
				<div class="content_inner">
					<div class="row contentscroll">
	<div class="container col-md-12">
          <div class="col-md-6 empty">&nbsp;</div>
                          <div class="col-md-6 content_text">
                          <div class="white_bg">
                     <h1>Appetizers <a href="sample.pdf" class="link"> <img src="<?php echo $baseUrl;?>/css/home/assets/img/pdf-icon.png" title="PDF Menu to Print" alt="PDF Menu to Print"></a></h1><p class="pad_top13">Entree hour table time with your choice of tropical mimosa, bloody mary and house beer.</p> <br />
...
<div id="menu2" class="item">
			<img src="<?php echo $baseUrl;?>/css/home/assets/img/7.jpg" alt="The Spice Lounge" class="fullBg">
			<div class="content">
	...
	<div class="container col-md-12">
          <div class="col-md-6 empty">&nbsp;</div>
                          <div class="col-md-6 content_text">
                          <h1>Menu with images (big) <a href="sample.pdf" class="link"> <img src="<?php echo $baseUrl;?>/css/home/assets/img/pdf-icon.png" title="PDF Menu to Print" alt="PDF Menu to Print"></a></h1>
                          <div class="home3">
			...
			<div class="row ">
            <div class="menu_content clearfix">
				<div class="col-md-3 menu_big"><div class="row"><img src="<?php echo $baseUrl;?>/css/home/assets/img/sp2.jpg"  class="img-responsive img_border" alt="" /></div></div>
				<div class="col-md-9 text-left">
				<div class="title-splider">
            ...
            <div class="menu_content clearfix">
				<div class="col-md-3 menu_big"><div class="row"><img src="<?php echo $baseUrl;?>/css/home/assets/img/sp4.jpg"  class="img-responsive img_border" alt="" /></div></div>
				<div class="col-md-9 text-left">
				<div class="title-splider">
...
<div class="modal-dialog">
        <div class="modal-content">
			<button class="close" data-dismiss="modal"><img src="<?php echo $baseUrl;?>/css/home/assets/img/close.png" alt=" "></button>
            <div class="modal-body">
				<div class="spimg">
	                <img src="<?php echo $baseUrl;?>/css/home/assets/img/event1.jpg" alt="..." class="img-responsive">				</div>
            </div>
        </div>
    </div>
</div>
...
<div id="lightbox3" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="todayspecial" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
        	<button type="button" class="close" data-dismiss="modal" ><img src="<?php echo $baseUrl;?>/css/home/assets/img/close.png" alt=" "></button>
            <div class="modal-body">
                <div class="content_overlay">
	<div class="content_text contentscroll">
                          <h1 class="text-center">Today Special's <a href="sample.pdf" class="link"> <img src="<?php echo $baseUrl;?>/css/home/assets/img/pdf-icon.png" title="PDF Menu to Print" alt="PDF Menu to Print"></a></h1><p>Your days specials labore et dolore magna aliquaenim amd  quis nostrud exercitation ullamco.</p> <br />
                          <!-- div one created -->
<div class="pad_top30">
    <div class="toggle-container">
        <div class="toggle-header">
...
<!--java script-->
<script type="text/javascript" src="<?php echo $baseUrl;?>/css/home/assets/js/bootstrap.min.js"></script>
<!-- Form Validation-->
<script type="text/javascript" src="<?php echo $baseUrl;?>/css/home/assets/js/jquery.validate.min.js"></script>
<!-- Form Validation End-->
<script type="text/javascript" src="<?php echo $baseUrl;?>/css/home/assets/js/bootstrap-datetimepicker.min.js"></script>
<script type="text/javascript" src="<?php echo $baseUrl;?>/css/home/assets/js/jquery.scrollTo.min.js"></script>
<script type="text/javascript" src="<?php echo $baseUrl;?>/css/home/assets/js/jquery.fitvids.js"></script>
<script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=false"></script>


<!-- SlickNavigation For Mobile Device-->
<script type="text/javascript" src="<?php echo $baseUrl;?>/css/home/assets/js/jquery.slicknav.min.js"></script>
<!-- SlickNavigation For Mobile Device Ends-->

<!-- Content NiceScroll -->
<script src="<?php echo $baseUrl;?>/css/home/assets/js/jquery.nicescroll.min.js"></script>
<script type="text/javascript" src="<?php echo $baseUrl;?>/css/home/assets/js/jquery.mousewheel.min.js"></script>
<script type="text/javascript" src="<?php echo $baseUrl;?>/css/home/assets/js/jquery.easing.1.3.js"></script>
<!-- Content NiceScroll End-->

<!-- include retina js -->
<script type="text/javascript" src="<?php echo $baseUrl;?>/css/home/assets/js/retina-1.1.0.min.js"></script>
<!-- include retina js Ends-->

<!-- Optional Scripts Starts -->

<!-- Preloader Starts -->
<script type="text/javascript" src="<?php echo $baseUrl;?>/css/home/assets/js/jpreloader.min.js"></script>
<!-- Preloader End -->

<!-- Cycle Slider Gallery Starts-->
<script type="text/javascript" src="<?php echo $baseUrl;?>/css/home/assets/js/jquery.cycle.all.js"></script>
<script type="text/javascript" src="<?php echo $baseUrl;?>/css/home/assets/js/jquery.cycle2.caption2.js"></script>
<!-- Cycle Slider Gallery End-->

<!--SuperSized Gallery-->
<script type="text/javascript" src="<?php echo $baseUrl;?>/css/home/assets/js/supersized.3.2.7.min.js"></script>
<script type="text/javascript" src="<?php echo $baseUrl;?>/css/home/assets/js/supersized.shutter.min.js"></script>
<script type="text/javascript" src="<?php echo $baseUrl;?>/css/home/assets/js/supersized_custom.js"></script>
<!--SuperSized Gallery End-->

<!-- Filter Gallery And PrettyPhoto-->
<script type="text/javascript" src="<?php echo $baseUrl;?>/css/home/assets/js/jquery.prettyPhoto.js"></script>
<script type="text/javascript" src="<?php echo $baseUrl;?>/css/home/assets/js/jquery.mixitup.min.js"></script>
<!-- Filter Gallery And PrettyPhoto End-->


<!-- Home Tiled Sldier -->
<script type="text/javascript" src="<?php echo $baseUrl;?>/css/home/assets/js/classie.js"></script>
<script type="text/javascript" src="<?php echo $baseUrl;?>/css/home/assets/js/boxesFx.js"></script>
<script type="text/javascript" src="<?php echo $baseUrl;?>/css/home/assets/js/wait.js"></script>
...
<!-- Custom Scripts -->
<script type="text/javascript" src="<?php echo $baseUrl;?>/css/home/assets/js/custom_general_box.js"></script>
<script type="text/javascript" src="<?php echo $baseUrl;?>/css/home/assets/js/custom_general.js"></script>
<!-- Custom Scripts End-->
