	...
	function buildSkeleton(maxRowCnt, showNumbers) {
		...
		for(var mi=0; mi<12; mi++){
			...
			s +="<table class='fc-border-separate' style='width:100%' cellspacing='0'>"+
				"<thead>"+
				"<tr><th colspan='7' class='fc-year-monthly-header'>"+localMonthNames[mi]+"</th></tr>"+
				"<tr>";
		for (i=0; i<colCnt; i++) {
		...
		for (i=0; i<6; i++) {
			...
			for (j=0; j<colCnt; j++) {
				...
				s +="<td class='fc- " + contentClass + " fc-day" + dayStr + "' data-day='"+ dayStr.substr(1) +"'>" + // need fc- for setDayID
					"<div>" +
					(showNumbers ?
