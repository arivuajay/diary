...
class TinyMce extends CInputWidget
{
    ...
    public function init()
    {
        ...
        $spellDir = dirname(__FILE__) . '/vendors/nanospell';
        $this->assetsDir = Yii::app()->assetManager->publish($dir);
        $this->assetsSpellDir = Yii::app()->assetManager->publish($spellDir);
    ...
    private function registerScripts($id)
    {
        ...
        $cs->registerScript("{$id}_tinyMce_init", "$('#{$id}').tinymce({$settings}); tinymce.init({
	selector:'textarea',
	external_plugins: {'nanospell': '{$this->assetsSpellDir}/plugin.js'},
